      ...
      <div className="card" style={{width: '18rem', height: '28em'}}>
        ...
        <div className="card-body">
          ...
          <select id='chooseType' class="form-select mb-2" aria-label="Choose a Media Type" required>
            <option selected>选择媒体类型</option>
            <option value="movie">Movie</option>
            <option value="book">Book</option>
            <option value="music">Music</option>
          </select>

          <input id="newTitle" class="form-control mb-2" type="text" placeholder="名称" aria-label="Title" required />
          ...
          <div class='mb-2 d-flex justify-content-between'>
            ...
            <label class="btn btn-success" style={{width: '45%'}} for="rating-alotl">上传</label>
